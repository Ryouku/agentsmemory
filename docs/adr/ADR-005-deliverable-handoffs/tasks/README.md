...
| [T3](T3-teach-the-convention-and-reconcile.md) | Put the convention where agents read it, and rescue the six orphans | corrected bootstrap + both centralised skills; reconciled wings | `confirm_new_wing` (T1) | done |
