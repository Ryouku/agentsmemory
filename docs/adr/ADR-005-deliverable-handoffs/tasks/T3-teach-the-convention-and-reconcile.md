...
- 2026-08-25 · 8c3167d* · exit 0 · `docker run --rm -v "$PWD":/src -v agentsmemory-gocache:/root/.cache/go-build -v agentsmemory-mod:/go/pkg/mod -w /src golang:1.26-alpine sh -c ' …` · acceptance-sha256:be5976e73b1835f7faa3e5c88adf0558b1e0660dbff1c909d80ceea518cf6739
- 2026-08-25 · 8c3167d* · exit 0 · `docker run --rm -v "$PWD":/src -v agentsmemory-gocache:/root/.cache/go-build -v agentsmemory-mod:/go/pkg/mod -w /src golang:1.26-alpine sh -c ' …` · acceptance-sha256:be5976e73b1835f7faa3e5c88adf0558b1e0660dbff1c909d80ceea518cf6739

## Mutation Log
- 2026-08-25 · 8c3167d* · mutant killed · exit 1 · `clients/claude-code/bootstrap.md` · the shipped protocol must teach that a target wing is named for the PROJECT and never for the direction of travel; that clause is the rule itself, and both real failures filed into wing_to-<project> for want of it · acceptance-sha256:be5976e73b1835f7faa3e5c88adf0558b1e0660dbff1c909d80ceea518cf6739
