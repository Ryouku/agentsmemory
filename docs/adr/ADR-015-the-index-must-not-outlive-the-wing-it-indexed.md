...
- Making `DrawerID` independent of the wing so a merge does not invalidate anything derived from the id (deferred: docs/adr/ADR-038-dedupe-on-the-content-refer-by-the-id.md)
