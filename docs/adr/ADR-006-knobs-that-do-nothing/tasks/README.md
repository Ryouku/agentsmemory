...
|------|------|----------|----------|--------|
| [T1](T1-extract-the-ranking-wiring.md) | Make the ranking wiring drivable without a server | `configureRanking` | none | todo |
...
| [T4](T4-fix-what-the-audit-found.md) | Fix the three defects the audit found | honest telemetry, settable timeout, scoped CLI search | none | todo |
