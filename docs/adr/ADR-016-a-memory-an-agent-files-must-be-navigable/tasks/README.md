...
| [T2](T2-entities-on-the-write-path.md) | A drawer an agent files carries its entities | populated `drawers.entities` | T1 | done — `Add` stamps entities per chunk, and the lexicon T1 caught admitting shouted prose is fixed first (47/163 ordinary words surviving → 2, every acronym kept) |
